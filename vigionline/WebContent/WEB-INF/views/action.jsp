...
<%@ include file="header.jsp" %>
	<div class="container">
		...
		<!-- End Navigation -->
		<div class="well">
			<form class="form-inline" action="<%= baseUrl %>/actions/${it.action.idAction }/delete" method="POST">
				<input type="hidden" name="idAction" value="${it.action.idAction }" />
				<a class="btn btn-primary" href="<%= baseUrl %>/actions/${it.action.idAction }/edit"><%= messages.getMessage("edit_action") %></a>
