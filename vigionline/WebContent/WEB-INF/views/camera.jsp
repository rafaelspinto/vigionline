...
<%@ include file="header.jsp" %>
	<div class="container">
		...
		<!-- End Navigation -->
		<div class="well">
			<form class="form-inline" action="<%= baseUrl %>/cameras/${it.camera.idCamera }/delete" method="POST">
				<input type="hidden" name="idCamera" value="${it.camera.idCamera }" />
				<a class="btn btn-primary" href="<%= baseUrl %>/cameras/${it.camera.idCamera }/edit"><%= messages.getMessage("edit_camera") %></a>
